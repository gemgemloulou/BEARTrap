...
double TRAP_FWHM=2.5;
int NCASE=100; 	/* number of ions TOTAL! */
//char* IsotopeFile=(char *)"IonFiles/CreatedByBarbara/137I_c2_a1/6NeutronStates_25keV-2MeV/137I_c2_a1.txt";
char* IsotopeFile;//=(char *)"137I_c2_a-0.33_4n.txt";
//char* EnergyFile=(char *)"IonFiles/137I/137XeRIPL.txt";
char* EnergyFile;//=(char *)"137XeRIPL.txt";
