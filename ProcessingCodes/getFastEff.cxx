...
void allEffTotal(){ // use this to get the correction per energy (from monoenergetic neutron distribution) to be applied to the spectrum.
  ...
  for(int i=0; i<4; i++) getEffTotal("../En/small_0.1MeV.root","../En/out_137I_g2_n_0.1MeV.root",i);
  for(int i=0; i<4; i++) getEffTotal("../En/small_1.0MeV.root","../En/out_137I_g2_n_1.0MeV.root",i);
